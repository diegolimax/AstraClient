ACHIEVEMENTS = {
	...
	[555] = { name = "Inner Peace", grade = 1, points = 3, description = "The transcendence to a higher state of mind and existence in order to achieve inner peace has been amplified by various means throughout Merudri history." },
	...
	[573] = { name = "Errand Runner", grade = 1, points = 3, description = "You've proven yourself as a reliable helper, running errands and completing weekly tasks without hesitation." },
	[574] = { name = "Feral Trapper", grade = 2, points = 4, description = "You dedicated yourself to countless hunting tasks and earned the respect of Walter Jaeger." },
	[575] = { name = "Pest Control", grade = 3, points = 6, description = "From clearing cellars of rats to hunting the most dangerous beasts, no creature is safe when you're on a bounty." },
	[576] = { name = "ID 576", grade = 1, points = 0, secret = true, description = "???" },
	[577] = { name = "Razor's Edge", grade = 2, points = 5, secret = true, description = "You completed The Gravedigger's challenge with exceptional precision, finishing with plenty of charges to spare." },
	[578] = { name = "Taskaholic", grade = 3, points = 6, description = "The bulletin board is your second home. No task is too small, no challenge too big." },
	[579] = { name = "ID 579", grade = 1, points = 0, secret = true, description = "???" },
	[580] = { name = "ID 580", grade = 1, points = 0, secret = true, description = "???" },
	[581] = { name = "Workhorse", grade = 2, points = 4, description = "Whether it's clearing cellars from rats or delivering quara eyes, you do the job regardless of the task type." },
}
